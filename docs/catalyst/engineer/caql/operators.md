...
sidebar_position: 30
layout: default
description: CAQL supports a number of operators that can be used in expressions
license: |
...
CAQL supports a number of operators that can be used in expressions.  There are
...
Some examples for comparison operations in CAQL:
...
expressions as specified in the documentation for the CAQL function
...
The following logical operators are supported in CAQL:

- `&&` logical and operator
- `||` logical or operator
- `!` logical not/negation operator

CAQL also supports the following alternative forms for the logical operators:
...
The two-operand logical operators in CAQL will be executed with short-circuit
...
The result of the logical operators in CAQL is defined as follows:
...
Some examples for logical operations in CAQL:
...
CAQL supports the following arithmetic operators:
...
CAQL also supports a ternary operator that can be used for conditional
...
CAQL supports expressing simple numeric ranges with the `..` operator.
...
The operator precedence in CAQL is similar as in other familiar languages
