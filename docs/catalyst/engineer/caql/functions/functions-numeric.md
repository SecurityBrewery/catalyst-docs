...
title: Numeric
layout: default
description: CAQL offers some numeric functions for calculations
license: |
...
CAQL offers some numeric functions for calculations. The following functions are
supported:
...
Also see [type and value order](../fundamentals-type-value-order).
