...
<!-- [array operators](advanced-array-operators) for array expansion and contraction,
...
of an object / document, <!-- the [amount of documents](functions-miscellaneous#length) in a collection -->
